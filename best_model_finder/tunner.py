...
class Model_Finder:
    ...
    def __init__(self):
        self.file_object = open('Training_Logs/Model_Finderlog.txt', 'a+')
    ...
    def get_best_params_for_svm(self,train_x,train_y):
        ...
        On Failure: Raise Exception
                        ...
                        """
        ob.log(self.file_object, 'Entered the get_best_params_for_svm method of the Model_Finder class')
        try:
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            if len(test_y.unique()) == 1:#if there is only one label in y, then roc_auc_score returns error. We will use accuracy in that case
                ...
                ob.log(self.file_object, 'Accuracy for SVM:' + str(self.svm_score))
            else:
                self.svm_score = roc_auc_score(test_y, self.prediction_svm) # AUC for Random Forest
                ob.log(self.file_object, 'AUC for SVM:' + str(self.svm_score))
